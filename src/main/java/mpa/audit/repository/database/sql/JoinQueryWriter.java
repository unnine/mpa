...
public class JoinQueryWriter implements QueryWriter {
    ...
    private final static String JOIN_ADDITION_NAME_PREFIX = "JAN__"; // JOIN_ADDITION_NAME
    ...
    public JoinQueryWriter(ScopedAuditConfiguration configuration, EntityCache entityCache) {
        this.joinStrategy = configuration.joinStrategy();
