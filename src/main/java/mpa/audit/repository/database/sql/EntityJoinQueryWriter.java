...
public class EntityJoinQueryWriter implements QueryWriter {
    ...
    private final static String JOIN_NAME_PREFIX = "EJ__"; // ENTITY_JOIN
    private final static String JOIN_ADDITIONAL_NAME_PREFIX = "EJA__"; // ENTITY_JOIN_ADDITIONAL

    private final StringCaseConverter stringCaseConverter;
    private final EntityCache entityCache;


    public EntityJoinQueryWriter(ScopedAuditConfiguration configuration, EntityCache entityCache) {
