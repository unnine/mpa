...
public final class AuditProvider {
    ...
    private static final Map<AuditScope, DependencyFactory> factories = new HashMap<>();

    static void addFactory(AuditScope key, DependencyFactory dependencyFactory) {
    ...
    private static DependencyFactory getDependencyFactory(String auditScopeName) {
        AuditScope scopeAware;

        for (Map.Entry<AuditScope, DependencyFactory> entry : factories.entrySet()) {
