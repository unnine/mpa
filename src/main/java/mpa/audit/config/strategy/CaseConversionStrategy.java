...
public enum CaseConversionStrategy {
    NONE(CaseConversionStrategy::none),
    CAMEL_TO_UPPER_SNAKE(CaseConversionStrategy::camelToUpperSnake),
    CAMEL_TO_LOWER_SNAKE(CaseConversionStrategy::camelToLowerSnake),
    SNAKE_TO_CAMEL(CaseConversionStrategy::snakeToCamel),
    ;

    private final Converter converter;


    CaseConversionStrategy(Converter converter) {
