...
import mpa.audit.event.AuditCommitEvent;
import mpa.audit.event.AuditEventPublisher;
...
public class AuditTransactionListener implements PersistenceTransactionListener {
